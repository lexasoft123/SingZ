...
const entry = `
export { detectBeats, estimateKey, estimateKeyFromStems, analysisIsStale, BEAT_DETECT_VERSION, KEY_DETECT_VERSION } from './analysis'
...
/** Upgrade, never downgrade: true only when the stored stamp is BELOW the
 *  app's (or missing), so an older build leaves a newer analysis alone. */
export declare function analysisIsStale(stamp: number | undefined | null, current: number): boolean
